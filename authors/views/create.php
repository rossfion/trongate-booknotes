        ...
        <div class="box box-primary">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    echo form_label('Author Name');
                    echo form_input('author_name', $author_name);

                    echo '<div>Author Status: ';
                    echo form_checkbox('author_status', 1, 0);
                    echo '</div>';
                    echo form_submit('submit', 'Submit');
                    echo anchor('authors/manage', 'Cancel', array("class" => "button alt"));
...
<div class='modal' id='confirm-delete' style='display:none;'>
    ...
    <div class='modal-body'>
        ...
        <?php
        echo form_open(BASE_URL . 'authors/submit_delete/' . $update_id, array('class' => 'text-center'));
